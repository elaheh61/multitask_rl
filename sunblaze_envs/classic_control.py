...
class ModifiableCartPoleEnv(CartPoleEnv, EnvBinarySuccessMixin, MetaEnv):
    ...
    # def set_task(self, task):
        ...
        # self.masspole = task['masspole']
        # self.total_mass = task['total_mass']
        # self.polemass_length = task['polemass_length']
...
class MetaNormalCartPole(ModifiableCartPoleEnv):
    def __init__(self):
        super(MetaNormalCartPole, self).__init__()
    ...
    def sample_tasks(self, num_tasks):
        length2 = self.np_random.uniform(self.RANDOM_LOWER_LENGTH, self.RANDOM_UPPER_LENGTH, size=(num_tasks, ))
        # print(length2)
        polemass_length2 = (self.masspole * length2)
        tasks=[]
        for i in range(num_tasks):
            d={}
            d['length'] = length2[i]
            d['polemass_length'] = polemass_length2[i]
            tasks.append(d)
    ...
    def reset(self, new=True):
        ...
        # print("polemass_length = ",self.polemass_length)
        # print("force_mag = ",self.force_mag)
        # print("masspole = ", self.masspole)
        # print("total_mass = ", self.total_mass)
        return np.array(self.state)

class MetaExtremeCartPole(ModifiableCartPoleEnv):
    def __init__(self):
        super(MetaExtremeCartPole, self).__init__()
    ...
    def sample_tasks(self, num_tasks):
        length2 = np.array([uniform_exclude_inner(self.np_random.uniform,
                self.EXTREME_LOWER_LENGTH, self.EXTREME_UPPER_LENGTH,
                self.RANDOM_LOWER_LENGTH, self.RANDOM_UPPER_LENGTH) for _ in range(num_tasks)])
        # print(length2)
        polemass_length2 = (self.masspole * length2)
        tasks=[]
        for i in range(num_tasks):
...
class RandomShortPoleCartPole(ModifiableCartPoleEnv):
    ...
    def sample_tasks(self, num_tasks):
        # force_mag2 = np.random.choice((self.RANDOM_LOWER_FORCE_MAG, self.RANDOM_UPPER_FORCE_MAG), (num_tasks,))
        length2 = self.np_random.uniform(self.RANDOM_LOWER_LENGTH, self.RANDOM_UPPER_LENGTH, size=(num_tasks, ))
        # print(length2)
        # masspole2 = np.random.choice((self.RANDOM_LOWER_MASSPOLE, self.RANDOM_UPPER_MASSPOLE), (num_tasks,))
        # self.total_mass = (self.masspole + self.masscart)
        polemass_length2 = (self.masspole * length2)
        tasks=[]
        for i in range(num_tasks):
...
class ModifiableAcrobotEnv(AcrobotEnv, MetaEnv):
...
class RandomNormalAcrobot(ModifiableAcrobotEnv):
    ...
    def set_task(self, task):
        ...
        self.mass = task['mass']
        self.length = task['length']
        self.inertia = task['inertia']

    def sample_tasks(self, num_tasks):
        mass2 = self.np_random.uniform(self.RANDOM_LOWER_MASS, self.RANDOM_UPPER_MASS, size=(num_tasks, ))
        length2 = self.np_random.uniform(self.RANDOM_LOWER_LENGTH, self.RANDOM_UPPER_LENGTH, size=(num_tasks, ))
        inertia2 = self.np_random.uniform(self.RANDOM_LOWER_INERTIA, self.RANDOM_UPPER_INERTIA, size=(num_tasks, ))
        tasks = []
        for i in range(num_tasks):
            d= {}
            d['mass'] = mass2[i]
            d['length'] = length2[i]
            d['inertia'] = inertia2[i]
            tasks.append(d)
...
class RandomExtremeAcrobot(ModifiableAcrobotEnv):
    ...
    def sample_tasks(self, num_tasks):
        # mass2 = np.array([uniform_exclude_inner(self.np_random.uniform,
        #     self.EXTREME_LOWER_MASS, self.EXTREME_UPPER_MASS,
        #     self.RANDOM_LOWER_MASS, self.RANDOM_UPPER_MASS) for _ in range(num_tasks)])
        length2 = np.array([uniform_exclude_inner(self.np_random.uniform,
            self.EXTREME_LOWER_LENGTH, self.EXTREME_UPPER_LENGTH,
            self.RANDOM_LOWER_LENGTH, self.RANDOM_UPPER_LENGTH) for _ in range(num_tasks)])
        # inertia2 = np.array([uniform_exclude_inner(self.np_random.uniform,
        #     self.EXTREME_LOWER_INERTIA, self.EXTREME_UPPER_INERTIA,
        #     self.RANDOM_LOWER_INERTIA, self.RANDOM_UPPER_INERTIA) for _ in range(num_tasks)])
        tasks = []
        for i in range(num_tasks):
            d= {}
            # d['mass'] = mass2[i]
